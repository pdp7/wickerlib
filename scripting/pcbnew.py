...
_pcbnew.ZONE_THERMAL_RELIEF_GAP_MIL_swigconstant(_pcbnew)
ZONE_THERMAL_RELIEF_GAP_MIL = _pcbnew.ZONE_THERMAL_RELIEF_GAP_MIL

_pcbnew.ZONE_THERMAL_RELIEF_COPPER_WIDTH_MIL_swigconstant(_pcbnew)
ZONE_THERMAL_RELIEF_COPPER_WIDTH_MIL = _pcbnew.ZONE_THERMAL_RELIEF_COPPER_WIDTH_MIL

_pcbnew.ZONE_THICKNESS_MIL_swigconstant(_pcbnew)
ZONE_THICKNESS_MIL = _pcbnew.ZONE_THICKNESS_MIL

_pcbnew.ZONE_THICKNESS_MIN_VALUE_MIL_swigconstant(_pcbnew)
ZONE_THICKNESS_MIN_VALUE_MIL = _pcbnew.ZONE_THICKNESS_MIN_VALUE_MIL

_pcbnew.ZONE_CLEARANCE_MIL_swigconstant(_pcbnew)
ZONE_CLEARANCE_MIL = _pcbnew.ZONE_CLEARANCE_MIL

_pcbnew.ZONE_CLEARANCE_MAX_VALUE_MIL_swigconstant(_pcbnew)
ZONE_CLEARANCE_MAX_VALUE_MIL = _pcbnew.ZONE_CLEARANCE_MAX_VALUE_MIL

_pcbnew.ZONE_ABORT_swigconstant(_pcbnew)
ZONE_ABORT = _pcbnew.ZONE_ABORT

_pcbnew.ZONE_OK_swigconstant(_pcbnew)
ZONE_OK = _pcbnew.ZONE_OK

_pcbnew.ZONE_EXPORT_VALUES_swigconstant(_pcbnew)
ZONE_EXPORT_VALUES = _pcbnew.ZONE_EXPORT_VALUES

_pcbnew.PAD_ZONE_CONN_INHERITED_swigconstant(_pcbnew)
PAD_ZONE_CONN_INHERITED = _pcbnew.PAD_ZONE_CONN_INHERITED

_pcbnew.PAD_ZONE_CONN_NONE_swigconstant(_pcbnew)
PAD_ZONE_CONN_NONE = _pcbnew.PAD_ZONE_CONN_NONE

_pcbnew.PAD_ZONE_CONN_THERMAL_swigconstant(_pcbnew)
PAD_ZONE_CONN_THERMAL = _pcbnew.PAD_ZONE_CONN_THERMAL

_pcbnew.PAD_ZONE_CONN_FULL_swigconstant(_pcbnew)
PAD_ZONE_CONN_FULL = _pcbnew.PAD_ZONE_CONN_FULL

_pcbnew.PAD_ZONE_CONN_THT_THERMAL_swigconstant(_pcbnew)
