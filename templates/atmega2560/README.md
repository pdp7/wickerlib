...
This is a KiCad template to make it easy to include the Atmega2560 in a project. 
...
1. <a href="https://github.com/wickerbox/wickerlib/blob/master/templates/atmega2560-template.zip?raw=true">Download the template zip</a> and extract into the location of 'KICAD_PTEMPLATES'.
