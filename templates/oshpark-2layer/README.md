...
1. <a href="https://github.com/wickerbox/wickerlib/blob/master/templates/oshpark-2layer/oshpark-2layer-template.zip?raw=true">Download the template zip</a> and extract into the location of 'KICAD_PTEMPLATES'.
